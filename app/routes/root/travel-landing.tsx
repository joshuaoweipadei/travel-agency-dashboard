...
const TravelLanding = ({ loaderData }: Route.ComponentProps) => {
  ...
  return (
    <main className="flex flex-col">
          ...
          <section className="wrapper">
            <article>
              ...
              <p className="text-dark-100">
                Customize your travel itinerary in minutes—pick your destination, set your preferences, and explore with
                confidence.
              </p>
            </article>
      ...
      <section className="pt-20 wrapper flex flex-col gap-10 h-full">
        <Header title="Featured Travel Destinations"
